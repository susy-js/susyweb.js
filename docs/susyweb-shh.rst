...
The ``susyweb-shh`` package allows you to interact with the whisper protocol for broadcasting.
For more see `Whisper  Overview <https://octonion.institute/susy-go/susy-graviton/wiki/Whisper>`_.


.. code-block:: javascript

    import SusyWeb from 'susyweb';
    import {Shh} import 'susyweb-shh';

    // "SusyWeb.givenProvider" will be set if in an Sophon supported browser.
    const shh = new Shh(SusyWeb.givenProvider || 'ws://some.local-or-remote.node:8546', null, options);
...
.. code-block:: javascript
    ...
    susyweb.shh.getVersion([callback])
...
.. code-block:: javascript
    ...
    susyweb.shh.getInfo().then(console.log);
    > {
        "minPow": 0.8,
...
.. code-block:: javascript
    ...
    susyweb.shh.setMaxMessageSize(size, [callback])
...
.. code-block:: javascript
    ...
    susyweb.shh.setMaxMessageSize(1234565)
    .then(console.log);
    > true
...
.. code-block:: javascript
    ...
    susyweb.shh.setMinPoW(pow, [callback])
...
The new value should be set relative to the old value (e.g. double). The old value can be obtained via :ref:`susyweb.shh.getInfo() <shh-getinfo>`.
...
.. code-block:: javascript
    ...
    susyweb.shh.markTrustedPeer(enode, [callback])
...
.. code-block:: javascript
    ...
    susyweb.shh.newKeyPair([callback])
...
.. code-block:: javascript
    ...
    susyweb.shh.addPrivateKey(privateKey, [callback])
...
.. code-block:: javascript
    ...
    susyweb.shh.addPrivateKey('0x8bda3abeb454847b515fa9b404cede50b1cc63cfdeddd4999d074284b4c21e15')
    .then(console.log);
...
.. code-block:: javascript
    ...
    susyweb.shh.deleteKeyPair(id, [callback])
...
.. code-block:: javascript
    ...
    susyweb.shh.deleteKeyPair('3e22b9ffc2387e18636e0a3d0c56b023264c16e78a2adcba1303cefc685e610f')
    .then(console.log);
    > true
...
.. code-block:: javascript
    ...
    susyweb.shh.hasKeyPair(id, [callback])
...
.. code-block:: javascript
    ...
    susyweb.shh.hasKeyPair('fe22b9ffc2387e18636e0a3d0c56b023264c16e78a2adcba1303cefc685e610f')
    .then(console.log);
    > true
...
.. code-block:: javascript
    ...
    susyweb.shh.getPublicKey(id, [callback])
...
.. code-block:: javascript
    ...
    susyweb.shh.getPublicKey('3e22b9ffc2387e18636e0a3d0c56b023264c16e78a2adcba1303cefc685e610f')
    .then(console.log);
...
.. code-block:: javascript
    ...
    susyweb.shh.getPrivateKey(id, [callback])
...
.. code-block:: javascript
    ...
    susyweb.shh.getPrivateKey('3e22b9ffc2387e18636e0a3d0c56b023264c16e78a2adcba1303cefc685e610f')
    .then(console.log);
...
.. code-block:: javascript
    ...
    susyweb.shh.newSymKey([callback])
...
.. code-block:: javascript
    ...
    susyweb.shh.addSymKey(symKey, [callback])
...
.. code-block:: javascript
    ...
    susyweb.shh.addSymKey('0x5e11b9ffc2387e18636e0a3d0c56b023264c16e78a2adcba1303cefc685e610f')
    .then(console.log);
...
.. code-block:: javascript
    ...
    susyweb.shh.generateSymKeyFromPassword(password, [callback])
...
.. code-block:: javascript
    ...
    susyweb.shh.generateSymKeyFromPassword('Never use this password - password!')
    .then(console.log);
...
.. code-block:: javascript
    ...
    susyweb.shh.hasSymKey(id, [callback])
...
.. code-block:: javascript
    ...
    susyweb.shh.hasSymKey('f6dcf21ed6a17bd78d8c4c63195ab997b3b65ea683705501eae82d32667adc92')
    .then(console.log);
    > true
...
.. code-block:: javascript
    ...
    susyweb.shh.getSymKey(id, [callback])
...
.. code-block:: javascript
    ...
    susyweb.shh.getSymKey('af33b9ffc2387e18636e0a3d0c56b023264c16e78a2adcba1303cefc685e610f')
    .then(console.log);
...
.. code-block:: javascript
    ...
    susyweb.shh.deleteSymKey(id, [callback])
...
.. code-block:: javascript
    ...
    susyweb.shh.deleteSymKey('bf31b9ffc2387e18636e0a3d0c56b023264c16e78a2adcba1303cefc685e610f')
    .then(console.log);
    > true
...
.. code-block:: javascript
   ...
   susyweb.shh.post(object [, callback])
...
.. code-block:: javascript
    ...
    Promise.all([
        susyweb.shh.newSymKey().then((id) => {identities.push(id);}),
        susyweb.shh.newKeyPair().then((id) => {identities.push(id);})
...
.. code-block:: javascript
    ...
    susyweb.shh.subscribe('messages', options [, callback])
...
.. code-block:: javascript
    ...
    susyweb.shh.subscribe('messages', {
...
.. code-block:: javascript
    ...
    susyweb.shh.clearSubscriptions()

Resets subscriptions.

.. note:: This will not reset subscriptions from other packages like ``susyweb-sof``, as they use their own requestManager.
...
.. code-block:: javascript
    ...
    susyweb.shh.newMessageFilter(options)
...
1. ``Object``: See :ref:`susyweb.shh.subscribe() options <shh-subscribeoptions>` for details.
...
.. code-block:: javascript
    ...
    susyweb.shh.deleteMessageFilter(id)
...
.. code-block:: javascript
    ...
    susyweb.shh.deleteMessageFilter('2b47fbafb3cce24570812a82e6e93cd9e2551bbc4823f6548ff0d82d2206b326')
    .then(console.log);
    > true
...
.. code-block:: javascript
    ...
    susyweb.shh.getFilterMessages(id)
...
``Promise<Array>`` - Returns an array of message objects like :ref:`susyweb.shh.subscribe() notification returns <shh-subscribenotificationreturns>`
...
.. code-block:: javascript
    ...
    susyweb.shh.getFilterMessages('2b47fbafb3cce24570812a82e6e93cd9e2551bbc4823f6548ff0d82d2206b326')
    .then(console.log);
    > [{
        "hash": "0x4158eb81ad8e30cfcee67f20b1372983d388f1243a96e39f94fd2797b1e9c78e",
        "padding": "",
