...
.. _susyweb-abstract-method-before-execution:
...
Reserved types:
 ...
 - ``sof-send-transaction-method`` - ``SofSendTransactionMethod``
...
.. _susyweb-abstract-method-after-execution:
...
.. _susyweb-abstract-method-execute:
...
.. _susyweb-abstract-method-set-arguments:
...
.. _susyweb-abstract-method-get-arguments:
