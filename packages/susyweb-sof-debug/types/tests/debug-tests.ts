...
import {Debug, Stats, TransactionTrace, WorldState, MemStats, BlockTraceResult} from 'susyweb-sof-debug';
...
// $ExpectType Promise<null>
debug.setVerbosityPattern("sof/*=6");

// $ExpectType Promise<null>
debug.setVerbosityPattern("sof/*=6", (error: Error, result: null) => {});
