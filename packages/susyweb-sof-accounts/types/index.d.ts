...
import {AbstractSusyWebModule, SignedTransaction, TransactionConfig, SusyWebModuleOptions} from 'susyweb-core';
import {provider} from 'susyweb-providers';
import * as net from 'net';

export class Accounts extends AbstractSusyWebModule {
