...
/**
 * @file Accounts.js
 * @author Samuel Furter <samuel@sophon.org>, Fabian Vogelsteller <fabian@sophon.org>
 * @date 2017
 */
...
import SRLP from 'sof-lib/lib/srlp';
import Bytes from 'sof-lib/lib/bytes';
import {encodeSignature, recover} from 'sof-lib/lib/account'; // TODO: Remove this dependency
import {AbstractSusyWebModule} from 'susyweb-core';
import Account from './models/Account';
import Wallet from './models/Wallet';

// TODO: Rename Accounts module to Wallet and move the Wallet class to the sof module.
export default class Accounts extends AbstractSusyWebModule {
    /**
    ...
    constructor(provider, utils, formatters, methodFactory, options, net) {
        ...
        this.defaultKeyName = 'susywebjs_wallet';
        this.accounts = {};
    ...
    hashMessage(data) {
        ...
        const preambleBuffer = Buffer.from(`\u0019Sophon Signed Message:\n${data.length}`);
        const sofMessage = Buffer.concat([preambleBuffer, messageBuffer]);

        return Hash.keccak256s(sofMessage);
    }

    /**
     * TODO: Add deprecation message and extend the signTransaction method in the sof module
     *
    ...
    recoverTransaction(rawTx) {
        const values = SRLP.decode(rawTx);
        ...
        const signingDataHex = SRLP.encode(signingData);
     ...
     * Decrypts account
     *
     * Note: Taken from https://octonion.institute/susy-js/sophonjs-wallet
     *
     * @method decrypt
     *
