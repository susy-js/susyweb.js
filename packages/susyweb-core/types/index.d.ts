...
import {AbstractMethodFactory} from 'susyweb-core-method';
import {
    BatchRequest,
    SusyWebSophonProvider,
    HttpProvider,
    HttpProviderOptions,
    IpcProvider,
    provider,
...
export class AbstractSusyWebModule {
    constructor(
        provider: provider,
    ...
    readonly currentProvider: SusyWebSophonProvider | HttpProvider | IpcProvider | WebsocketProvider | CustomProvider;
...
export interface SusyWebModuleOptions {
...
export interface SRLPEncodedTransaction {
    raw: string;
    tx: {
        nonce: string;
        gasPrice: string;
...
export interface NodeInfo {
    ...
    protocols: any // Any because it's not documented what each protocol (sof, shh etc.) is defining here
}
