...
import {
    ...
    ProviderDetector,
    ProviderResolver
} from 'susyweb-providers';
import {MethodProxy} from 'susyweb-core-method';
import {toChecksumAddress} from 'susyweb-utils';

export default class AbstractSusyWebModule {
    /**
     * @param {AbstractSocketProvider|HttpProvider|String|SophonProvider} provider
    ...
    constructor(provider, options = {}, methodFactory = null, nodeNet = null) {
        // ProviderDetector and ProviderResolver are created in the constructor for providing a simpler SusyWeb Module API.
    ...
    /**
     * Returns a object with factory methods for the SusyWeb providers.
     *
     * @property providers
     *
     * @returns {Object}
     ...
     * TODO: AbstractSusyWebModule (factory.createAddress())
     *
