...
describe('UtilsTest', () => {
    ...
    it('calls fromWei and returns the expected results', () => {
        ...
        expect(fromWei('1000000000000000000', 'sophy')).toEqual('1');

        expect(fromWei('1000000000000000000', 'ksophy')).toEqual('0.001');

        expect(fromWei('1000000000000000000', 'grand')).toEqual('0.001');

        expect(fromWei('1000000000000000000', 'msophy')).toEqual('0.000001');

        expect(fromWei('1000000000000000000', 'gsophy')).toEqual('0.000000001');

        expect(fromWei('1000000000000000000', 'tsophy')).toEqual('0.000000000001');
    });
    ...
    it('calls toWei and returns the expected results', () => {
        ...
        expect(toWei('1', 'sophy')).toEqual('1000000000000000000');

        expect(toWei('1', 'ksophy')).toEqual('1000000000000000000000');

        expect(toWei('1', 'grand')).toEqual('1000000000000000000000');

        expect(toWei('1', 'msophy')).toEqual('1000000000000000000000000');

        expect(toWei('1', 'gsophy')).toEqual('1000000000000000000000000000');

        expect(toWei('1', 'tsophy')).toEqual('1000000000000000000000000000000');

        expect(toWei('1', 'kwei')).toEqual(toWei('1', 'femtosophy'));

        expect(toWei('1', 'szabo')).toEqual(toWei('1', 'microsophy'));

        expect(toWei('1', 'finney')).toEqual(toWei('1', 'millisophy'));

        expect(toWei('1', 'milli')).toEqual(toWei('1', 'millisophy'));
