...
describe('IbanTest', () => {
    ...
    it('calls createIndirect and returns the expected Iban object', () => {
        expect(Iban.createIndirect({institution: 'ME', identifier: 'SAM'}).toString()).toEqual('XE63SOFMESAM');
    });
    ...
    it('calls the static isValid method', () => {
        const tests = [
            ...
            {object: '{"c" : 2}', is: false},
            {object: 'XE81SOFXREGGAVOFYORK', is: true},
            {object: 'XE82SOFXREGGAVOFYORK', is: false}, // control number is invalid
            {object: 'XE81ETCXREGGAVOFYORK', is: false},
            {object: 'XE81SOFXREGGAVOFYORKD', is: false},
            {object: 'XE81SOFXREGGaVOFYORK', is: false},
