...
export default class AbiCoder {
    /**
     * @param {Utils} utils
     * @param {SophysAbiCoder} sophysAbiCoder
     *
     * @constructor
     */
    constructor(utils, sophysAbiCoder) {
        this.utils = utils;
        this.sophysAbiCoder = sophysAbiCoder;
    }
    ...
    encodeParameters(types, params) {
        return this.sophysAbiCoder.encode(types, params);
    }
    ...
    decodeParameters(outputs, bytes) {
        ...
        const result = this.sophysAbiCoder.decode(outputs, bytes);
        let returnValues = {};
        let decodedValue;
