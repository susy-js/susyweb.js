...
export default class AbstractSocketProvider extends EventEmitter {
    /**
     * @param {WebSocket|Socket|SusyWebSophonProvider} connection
     ...
     */
    subscribe(subscribeMethod = 'sof_subscribe', subscriptionMethod, parameters) {
     ...
     */
    unsubscribe(subscriptionId, unsubscribeMethod = 'sof_unsubscribe') {
     ...
     * @returns {Promise<Boolean|Error>}
     */
    clearSubscriptions(unsubscribeMethod = 'sof_unsubscribe') {
