...
describe('AbstractSocketProviderTest', () => {
    ...
    it('calls onConnect and connect event will be emitted', async () => {
        ...
        abstractSocketProvider.subscriptions['0x0'] = {
            id: '0x0',
            subscribeMethod: 'sof_subscribe',
            parameters: ['logs', {}]
        };

        abstractSocketProvider.send = jest.fn((subscribeMethod, parameters) => {
            expect(subscribeMethod).toEqual('sof_subscribe');
    ...
    it('calls unsubscribe and subscription id does not exist', () => {
        expect(abstractSocketProvider.unsubscribe('no', 'sof_unsubscribe')).rejects.toThrow(
    ...
    it('calls unsubscribe and resolves to a promise', async () => {
        ...
        abstractSocketProvider.send = jest.fn((subscribeMethod, parameters) => {
            expect(subscribeMethod).toEqual('sof_unsubscribe');
        ...
        const reaponse = await abstractSocketProvider.unsubscribe('0x0', 'sof_unsubscribe');
    ...
    it('calls clearSubscriptions and one unsubscribe call returns false', async () => {
        ...
        await expect(abstractSocketProvider.clearSubscriptions('sof_unsubscribe')).rejects.toThrow(
    ...
    it('calls clearSubscriptions and all unsubscribe calls are returning true', async () => {
        ...
        const response = await abstractSocketProvider.clearSubscriptions('sof_unsubscribe');
