...
describe('ProvidersModuleFactoryTest', () => {
    ...
    it('createSophonProvider returns instance of SophonProvider', () => {
        expect(providersModuleFactory.createSusyWebSophonProvider({})).toBeInstanceOf(SusyWebSophonProvider);
    });
});
