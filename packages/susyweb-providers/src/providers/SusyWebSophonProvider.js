...
export default class SusyWebSophonProvider extends AbstractSocketProvider {
    /**
    ...
    constructor(connection) {
        ...
        this.host = 'SusyWebSophonProvider';
    }
    ...
    /**
     * This is the listener for the 'message' events of the current SophonProvider connection.
     *
     * @method onMessage
     *
