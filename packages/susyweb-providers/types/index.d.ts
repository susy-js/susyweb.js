...
export class BatchRequest {
    constructor(moduleInstance: AbstractSusyWebModule);
...
export class ProvidersModuleFactory {
    createBatchRequest(moduleInstance: AbstractSusyWebModule): BatchRequest;
    ...
    createSusyWebSophonProvider(connection: object): SusyWebSophonProvider;
}
...
export class HttpProvider {
    ...
    sendBatch(methods: AbstractMethod[], moduleInstance: AbstractSusyWebModule): Promise<any[]>;
...
export class SusyWebSophonProvider extends AbstractSocketProvider {
    constructor(sophonProvider: any);
}
...
export type provider = HttpProvider | IpcProvider | WebsocketProvider | SusyWebSophonProvider | CustomProvider | string | null;
