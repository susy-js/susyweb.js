...
export default class TransactionObserver {
    ...
    /**
     * Observes the transaction with the newHeads subscriptions which sends the sof_getTransactionReceipt method on each item
     *
    ...
    /**
     * Observes the transaction with sending sof_getTransactionReceipt and checking if there is really a new block
     *
