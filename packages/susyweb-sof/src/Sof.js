...
export default class Sof extends AbstractSusyWebModule {
    /**
    ...
    constructor(
        ...
        /**
         * This wrapper function is required for the "new susyweb.sof.Contract(...)" call.
         *
         * @param {Object} abi
     ...
     */
    clearSubscriptions() {
        return super.clearSubscriptions('sof_unsubscribe');
    }
    ...
    /**
     * Extends setProvider method from AbstractSusyWebModule.
     * This is required for updating the provider also in the sub packages and objects related to Sof.
     *
