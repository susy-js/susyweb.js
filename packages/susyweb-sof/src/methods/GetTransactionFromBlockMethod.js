...
import {AbstractGetTransactionFromBlockMethod} from 'susyweb-core-method';
...
export default class GetTransactionFromBlockMethod extends AbstractGetTransactionFromBlockMethod {
    ...
    constructor(utils, formatters, moduleInstance) {
        super('sof_getTransactionByBlockNumberAndIndex', utils, formatters, moduleInstance);
    }
    ...
    beforeExecution(moduleInstance) {
        if (this.isHash(this.parameters[0])) {
            this.rpcMethod = 'sof_getTransactionByBlockHashAndIndex';
        }
