...
import {
    ...
    Log,
    PromiEvent,
    SRLPEncodedTransaction,
    Transaction,
    TransactionConfig,
    TransactionReceipt,
    SusyWebModuleOptions,
} from 'susyweb-core';
import {Contract, ContractOptions} from 'susyweb-sof-contract';
...
import {AbiItem} from 'susyweb-utils';
import {Ens} from 'susyweb-sof-ens';
import * as net from 'net';

export class Sof extends AbstractSusyWebModule {
    constructor(
        provider: provider,
        net?: net.Socket | null,
    ...
    signTransaction(transactionConfig: TransactionConfig, callback?: (error: Error, signedTransaction: SRLPEncodedTransaction) => void): Promise<SRLPEncodedTransaction>;
    signTransaction(transactionConfig: TransactionConfig, address: string): Promise<SRLPEncodedTransaction>;
    signTransaction(transactionConfig: TransactionConfig, address: string, callback: (error: Error, signedTransaction: SRLPEncodedTransaction) => void): Promise<SRLPEncodedTransaction>;
