...
describe('SofSignMethodTest', () => {
    ...
    beforeEach(() => {
        ...
        method = new SofSignMethod(Utils, formatters, moduleInstanceMock);
    ...
    it('calls execute and the account does not exist in the sof-accounts wallet', async () => {
        ...
        expect(moduleInstanceMock.currentProvider.send).toHaveBeenCalledWith('sof_sign', method.parameters);
    });
});
