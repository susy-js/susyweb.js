...
describe('GetBlockTransactionCountMethodTest', () => {
    ...
    it('constructor check', () => {
        expect(getBlockTransactionCountMethod.rpcMethod).toEqual('sof_getBlockTransactionCountByNumber');
    });
    ...
    it('calls execute with hash', () => {
        ...
        expect(getBlockTransactionCountMethod.rpcMethod).toEqual('sof_getBlockTransactionCountByHash');
    });
